...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar">
    ...
    <div class="w3-bar-block">
        ...
        <a href="교내정보.html" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-user fa-fw w3-margin-right"></i>교내정보</a>
        ...
        <div class="w3-row-padding" style="margin:0 -16px">
            ...
            <div class="table">
                <table class="w3-table w3-striped w3-white">
                    ...
                    <tr>
                        <td>1</td>
                        <td><i class="fa fa-user fa-fw w3-margin-right"></i></td>
