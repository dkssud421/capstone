    ...
    <div class="w3-container w3-content" style="max-width:1400px;">
        ...
        <div class="w3-row">
            ...
            <div class="w3-container w3-card w3-white w3-round w3-margin w3-border-bottom">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $lecture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lectures): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="title">
                        <h4> <?php echo e($lectures->title); ?><span style=" font-size:0.8em; color:grey;"> <?php echo e($lectures->professor); ?>교수님</span></h4>
                    </div>
                    <hr class="w3-clear">
                    <p> <?php echo e($lectures->content); ?> </p><br>
                    <a class="w3-button w3-teal w3-right w3-margin-bottom " href="/lecture/<?php echo e($lectures->id); ?>">&nbsp;Comment</a><br><br><br>
...
<br>
        <?php if($lecture ->count()): ?>
             <div class="text-center">
             <?php echo e($lecture->render()); ?>
