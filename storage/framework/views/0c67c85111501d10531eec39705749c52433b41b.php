...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <h1>강의추천 작성</h1>
        <hr/>
            <form method="POST" action="<?php echo e(route('lecture.store')); ?>">
               <?php echo csrf_field(); ?>
            ...
            <div class="from-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
                ...
                <div class="from-group <?php echo e($errors->has('professor') ? 'has-error' : ''); ?>">
                    <label for="professor">교수님 성함</label>
                    <input type="text" name="professor" id="professor" value="<?php echo e(old('professor')); ?>" class="form-control"/>
                    <?php echo $errors->first('professor', '<span class="from-error">:message</span>'); ?>
